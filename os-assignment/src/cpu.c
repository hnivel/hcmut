...
int calc(struct pcb_t *proc) { return ((unsigned long)proc & 0UL); }
...
int read(struct pcb_t *proc,     // Process executing the instruction
...
int write(struct pcb_t *proc,   // Process executing the instruction

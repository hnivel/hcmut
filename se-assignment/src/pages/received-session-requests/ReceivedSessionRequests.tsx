        ...
        <main className='w-full flex-1 py-6 md:py-8 lg:py-12 xl:py-16'>
          <div className='page-container'>
            ...
            <div className='page-header'>
              <h1 className='page-title'>Received Session Requests</h1>
            </div>
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/40 text-left'>
          <div className='relative w-full max-w-4xl rounded-3xl bg-white p-8 shadow-xl'>
            ...
            <div className='flex flex-col justify-between gap-8 md:flex-row'>
              {/* === Left Side === */}
              <div className='3xl:text-2xl flex-1 space-y-4 text-lg text-gray-700'>
                {/* Status */}
              ...
              {/* === Right Side === */}
              <div className='3xl:text-2xl flex-1 border-l pl-8 text-lg text-gray-700'>
                {selectedRequest.proposedTimes &&
                  selectedRequest.proposedTimes.length > 0 && (
                    <>
                      <h3 className='mb-3 text-xl font-semibold text-gray-800'>
                        {selectedRequest.title === 'Session Invitation'
                          ? 'Session Time'
                          : 'Proposed Time'}
                      </h3>
                          ...
                          .map((t, i) => {
                            ...
                            return (
                              <li
                                key={i}
                                onClick={() =>
                                  isSelectable ? setSelectedTime(i) : null
                                }
                          ...
                          .map((loc, i) => {
                            ...
                            return (
                              <li
                                key={i}
                                onClick={() =>
                                  isSelectable ? setSelectedLocation(i) : null
                                }
                                className={`flex items-center justify-between rounded-lg border px-4 py-2 ${
                                  isSelectable
                                    ? 'cursor-pointer hover:bg-gray-50'
                                  ...
                                  isSelectable && selectedLocation === i
                                    ? 'border-blue-500 bg-blue-50'
                                    : 'border-gray-200'
                                }`}
                              >
                ...
                {selectedRequest.status === 'Pending' && (
                  <div className='mt-6 flex gap-3'>
                    <button
                      className='text-md 3xl:text-xl flex-1 rounded-lg border border-gray-300 px-4 py-2 font-medium text-gray-700 transition hover:bg-gray-100'
                      onClick={handleReject}
                    >
                      Reject
                    </button>
                    <button
                      className='text-md 3xl:text-xl flex-1 rounded-lg bg-blue-500 px-4 py-2 font-medium text-white transition hover:bg-blue-600 disabled:cursor-not-allowed disabled:bg-gray-300'

...
class Emitter:
    ...
    def emit_if_icmp_eq(self, label: int, frame) -> str:
        """
        Generate code to jump to label if the two integers on top of operand stack are equal.
        
        Args:
            label: The label where the execution continues if the values are equal
            frame: Frame object for stack management

...
/* Extract PTE */
#define PAGING_PTE_OFFST(pte)                                                  \
    GETVAL(pte, PAGING_OFFST_MASK, PAGING_ADDR_OFFST_LOBIT)
...
#define PAGING_PTE_SWP(pte)                                                    \
    GETVAL(pte, PAGING_PTE_SWPOFF_MASK, PAGING_SWPFPN_OFFSET)
